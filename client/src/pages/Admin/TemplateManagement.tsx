...
const PLACEHOLDERS = [
    ...
    { tag: '{{employmentType}}', desc: "Full-Time / Part-Time" },
    { tag: '{{workingDays}}', desc: "Working Days (e.g. Monday to Friday)" },
    { tag: '{{workingHours}}', desc: "Working Hours (e.g. 09:00 AM - 06:00 PM)" },
    { tag: '{{probationDays}}', desc: "Probation period in days (e.g. 90)" },
    { tag: '{{probationMonths}}', desc: "Probation period in months (e.g. 3)" },
    { tag: '{{probationSalary}}', desc: "Salary during probation" },
    { tag: '{{companyResources}}', desc: "Resources provided during probation" },
    { tag: '{{confirmedSalary}}', desc: "Confirmed salary after probation" },
    { tag: '{{commissionStructure}}', desc: "Commission / Bonus structure" },
    { tag: '{{benefitsList}}', desc: "List of company benefits" },
    { tag: '{{taxCondition}}', desc: "Tax deduction terms" },
    { tag: '{{signatoryName}}', desc: "Authorized signatory name" },
    { tag: '{{signatoryDesignation}}', desc: "Signatory title / designation" },
    { tag: '{{hrEmail}}', desc: "HR contact email address" },
    { tag: '{{hrPhone}}', desc: "HR contact phone number" },
    ...
    { tag: '{{confirmedNoticePeriod}}', desc: "Notice period after confirmation (e.g. 30 Days)" },
