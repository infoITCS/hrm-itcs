...
const Sidebar = ({ isOpen = false, onClose }: SidebarProps) => {
    ...
    const allMenuItems = [
        ...
        { name: 'Expense Claim', icon: Banknote, path: '/claim', roles: null, module: 'claim' },
        { name: 'My Payslips', icon: Banknote, path: '/my-payslips', roles: ['super-admin', 'admin', 'manager', 'employee', 'hr', 'finance'], end: true },
